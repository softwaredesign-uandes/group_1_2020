...
class TestLoadBlockModel(unittest.TestCase):
    ...
    def test_retrieve_columns_types_invalid_types(self):
        ...
        column_types_empty = []
        self.assertEqual(lbm.retrieve_columns_types(test_block_file_path), column_types, False)
        self.assertEqual(lbm.retrieve_columns_types(test_block_file_path), column_types_empty, False)
